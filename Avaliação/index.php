...
<body>
      ...
      <div class="content">
        <div class="left-side">
          ...
          <div class="right-side">
            <div class="topic-text">Envie sua avaliação</div>
            <p>
            ...
            <form method="POST">
              <div class="input-box">
                <input type="text" name="nomeusuario" id="nomeusuario" placeholder="Digite seu nome" />
              </div>
              <div class="input-box">
                <input type="email" name="email" id="email" placeholder="Digite seu email" />
              </div>
              <div class="input-box">
                <input type="text" name="nomepro" id="nomepro" placeholder="Digite o nome do Produto:" />
              </div>
                <input type="text" name="avaliacao" id="avaliacao" placeholder="Qual sua opinião sobre o produto?>
              <div class="button">
  ...
  if (isset($_POST['nomeusuario'])) {
    ...
    if (!empty($nomeusuario) && !empty($avaliacao)  && !empty($nomepro) && !empty($email)) {
      $u->conectar("sa", "localhost", "root", "");
      if ($u->msgErro == "") {
        if (!$u->cadastrarAva($nomeusuario, $avaliacao, $nomepro, $email)) {
  ?>
          <div class="botãoCadSucess">
            Avaliação cadastrada com sucesso!!
          </div>
        <?php
        header("location: ../Avaliação_sucess/index.php");
        ob_end_flush();
        } else {
        ?>
          <div class="botãoCadSucess">
